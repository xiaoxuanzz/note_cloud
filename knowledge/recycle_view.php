...
<body>
    <div class="container mt-5">
        <div class="row">
            <div class="col-md-12">
                <h1>查看笔记</h1>
                <a href="../recycle.php" class="btn btn-secondary">返回回收站</a>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-md-12">
                        ...
                        <div class="d-flex justify-content-between mt-2">
                            ...
                            <div>
                                <?php if (isset($_SESSION['user_id']) && $_SESSION['user_id'] == $note['user_id']): ?>
                                    ...
                                    <a href="delete.php?id=<?php echo $note['id']; ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('确定删除此笔记吗？')">删除</a>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
